...
public class TargetScript : MonoBehaviour
{
  ...
  void FixedUpdate()
  {
    ...
    var shootParticles = GameObject.Find("ShootEffect").transform.parent.position;
    _target = new Vector2(shootParticles.x, shootParticles.y);
    var distance = new Vector3(_target.x, _target.y, 0f) - _rb.position;
