     ...
     Lighting On
      ...
      fixed4 _Color;
       ...
       v2f vert(appdata_full v)
       {
        ...
        vertex.x = floor(200 * vertex.x) / 200;
        vertex.y = floor(160 * vertex.y) / 165;
       ...
       //	o.color =  float4(ShadeVertexLights(v.vertex, v.normal), 1.0);
        ...
        o.uv_MainTex = TRANSFORM_TEX(v.vertex, _MainTex);
       ...
       float4 frag(v2f IN) : COLOR
       {
        ...
        half4 c = tex2D(_MainTex, (IN.uv_MainTex / IN.normal.r) * _MainTex_ST)*IN.color;
